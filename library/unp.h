...
/* OSF/1 actually disables recv() and send() in <sys/socket.h> */
  ...
  #define INET_ADDRSTRLEN 16 /* "ddd.ddd.ddd.ddd" 1234567890123456*/
#endif
...
#define BUFFSIZE 8193 /* buffer size for reads and writes */
...
#define HAVE_STRUCT_SOCKADRR_STORAGE
#ifndef HAVE_STRUCT_SOCKADDR_STORAGE
  /*
      RFC 3493: protocol-independent placeholder for socket addresses
  */
  #define __SS__MAXSIZE 128
  #define __SS_ALIGNSIZE (sizeof(int64_t))
  #ifdef HAVE_SOCKADDR_SA_LEN
    #define __SS_PAD1SIZE                                                      \
      (__SS_ALIGNSIZE - sizeof(u_char) - sizeof(sa_family_t))
  #else
    #define __SS_PAD1SIZE (__SS_ALIGNSIZE - sizeof(sa_family_t))
  #endif
  #define __SS_PAD2_SIZE (__SS__MAXSIZE - 2 * __SS_ALIGNSIZE)
